...
verify_divine: src/verify_divine.cpp
	$(CXX) $(CXXFLAGS) $(INCLUDES) -I/usr/local/openfhe/include $< -o $@ $(LDFLAGS) $(LIBS)
...
verify_divine: src/verify_divine.cpp
	@echo "=== Compiling Verify Divine ==="
	$(CXX) $(CXXFLAGS) $(INCLUDES) -I/usr/local/openfhe/include -I/usr/local/include $< -o bin/$@ $(LDFLAGS) $(LIBS) -lopenfhe -lntl -lgmp

verify_noise: src/verify_noise.cpp
	@echo "=== Compiling Noise Test ==="
	$(CXX) $(CXXFLAGS) $(INCLUDES) -I/usr/local/openfhe/include -I/usr/local/include $< -o bin/$@ $(LDFLAGS) $(LIBS) -lopenfhe -lntl -lgmp

verify_zans: src/verify_zans.cpp
	@echo "=== Compiling ZANS Test ==="
	$(CXX) $(CXXFLAGS) $(INCLUDES) -I/usr/local/openfhe/include -I/usr/local/include $< -o bin/$@ $(LDFLAGS) $(LIBS) -lopenfhe -lntl -lgmp

verify_all: verify_divine verify_noise verify_zans
	@echo "=== Running All Verification Tests ==="
	@echo ""
	@echo "--- Test 1: Basic Multiplication ---"
	./bin/verify_divine
	@echo ""
	@echo "--- Test 2: Noise Growth ---"
	./bin/verify_noise
	@echo ""
	@echo "--- Test 3: ZANS Stability ---"
	./bin/verify_zans
	@echo ""
	@echo "=== All Tests Complete ==="

# Override verification targets with correct includes
verify_divine_fixed: src/verify_divine.cpp
	@echo "=== Compiling Verify Divine (Fixed) ==="
	$(CXX) $(CXXFLAGS) \
		-I/usr/local/openfhe/include \
		-I/usr/local/openfhe/include/openfhe \
		-I/usr/local/openfhe/include/openfhe/pke \
		-I/usr/local/openfhe/include/openfhe/lattice \
		-I/usr/local/include \
		src/verify_divine.cpp \
		-o bin/verify_divine \
...
verify_noise_fixed: src/verify_noise.cpp
	@echo "=== Compiling Noise Test (Fixed) ==="
	$(CXX) $(CXXFLAGS) \
		-I/usr/local/openfhe/include \
		-I/usr/local/openfhe/include/openfhe \
		-I/usr/local/openfhe/include/openfhe/pke \
...
verify_zans_fixed: src/verify_zans.cpp
	@echo "=== Compiling ZANS Test (Fixed) ==="
	$(CXX) $(CXXFLAGS) \
		-I/usr/local/openfhe/include \
		-I/usr/local/openfhe/include/openfhe \
		-I/usr/local/openfhe/include/openfhe/pke \
...
verify_all_fixed: verify_divine_fixed verify_noise_fixed verify_zans_fixed
	@echo ""
	@echo "╔══════════════════════════════════════════════════════╗"
	@echo "║     RUNNING ALL VERIFICATION TESTS                  ║"
	@echo "╚══════════════════════════════════════════════════════╝"
...
# ============================================================
# FINAL VERIFICATION TESTS (WITH CORE INCLUDE)
# ============================================================

verify_final: src/verify_divine.cpp
	@echo "=== Compiling Final Verification ==="
	$(CXX) $(CXXFLAGS) \
		-I/usr/local/openfhe/include \
		-I/usr/local/openfhe/include/openfhe \
...
verify_noise_final: src/verify_noise.cpp
	@echo "=== Compiling Noise Test (Final) ==="
	$(CXX) $(CXXFLAGS) \
		-I/usr/local/openfhe/include \
		-I/usr/local/openfhe/include/openfhe \
		-I/usr/local/openfhe/include/openfhe/core \
...
verify_zans_final: src/verify_zans.cpp
	@echo "=== Compiling ZANS Test (Final) ==="
	$(CXX) $(CXXFLAGS) \
		-I/usr/local/openfhe/include \
		-I/usr/local/openfhe/include/openfhe \
		-I/usr/local/openfhe/include/openfhe/core \
...
verify_all_final: verify_final verify_noise_final verify_zans_final
	@echo ""
	@echo "╔══════════════════════════════════════════════════════╗"
