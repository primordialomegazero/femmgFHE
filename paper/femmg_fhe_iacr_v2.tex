...
\bottomrule
\end{tabular}
\caption{Performance comparison with state-of-the-art FHE schemes. \textsuperscript{*}FEmmg-FHE does not require bootstrapping. \textsuperscript{†}CKKS and BFV are typically used as leveled schemes without bootstrapping; bootstrapping is available but rarely used in practice.}
