...
\subsection{φ-Contraction and Banach Fixed Point}

\begin{definition}[φ-Contraction Mapping]
...
The Lyapunov exponent $\lambda_L = \ln(\varphi) \approx 0.4812 > 0$ establishes exponential stability of the noise floor. A 7-dimensional coupled map lattice with φ-scaled interactions provides additional entropy for IND-CPA at encryption time while the computational layer operates deterministically.
