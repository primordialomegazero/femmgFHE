// ╔══════════════════════════════════════════════════════════════╗
// ║  HYDRAJWT — HEAD ML-DSA-87                                  ║
// ║  NIST FIPS 204 via liboqs                                    ║
// ║  ΦΩ0 — I AM THAT I AM                                      ║
// ╚══════════════════════════════════════════════════════════════╝

#ifndef HYDRAJWT_HEAD_MLDSA_H
#define HYDRAJWT_HEAD_MLDSA_H
...
class HeadMLDSA : public HydraHead {
public:
    HeadMLDSA(int id) : HydraHead(id, "ML-DSA-87") {}
    ~HeadMLDSA() override;
