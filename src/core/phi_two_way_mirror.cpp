...
public:
    PhiTwoWayMirror() {
        ...
        cout << "========================================\n";
        cout << "  φ-TWO-WAY MIRROR\n";
        cout << "  NAND ↔ AND via φ-mirror\n";
        cout << "========================================\n\n";
    ...
    void run() {
        ...
        cout << "  TWO-WAY MIRROR:\n";
        cout << "  - Mirror(x) = √5 - x\n";
        cout << "  - NAND = Mirror(AND)\n";
        cout << "  - AND = Mirror(NAND)\n";
        cout << "  - NOT = Mirror(value)\n\n";
    }
};

int main() {
    PhiTwoWayMirror compiler;
    compiler.run();
    return 0;
}
