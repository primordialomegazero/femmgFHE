// ============================================
// φ-RULE 110 MULTI-LOG SPACE
//
// L: log base φ⁻¹ (left)
// C: log base φ⁰ (center)
// R: log base φ¹ (right)
//
// Iba't ibang log space per position
//
...
int main() {
    ...
    cout << "========================================\n";
    cout << "  EVOLUTION (MULTI-LOG)\n";
    cout << "========================================\n\n";

    // Initial state: L, C, R with different log bases
    vector<Ciphertext<DCRTPoly>> cells_L, cells_C, cells_R;
    for (int bit : history[0]) {
        cells_L.push_back(encrypt_multi(bit, LOG_BASE_L));
        cells_C.push_back(encrypt_multi(bit, LOG_BASE_C));
        cells_R.push_back(encrypt_multi(bit, LOG_BASE_R));
    }
    ...
    for (int gen = 1; gen <= 20; gen++) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            // Sum: L + C + R (different log bases!)
            auto sum1 = cc->EvalAdd(L, C);
            auto sum2 = cc->EvalAdd(sum1, R);
            
            // Re-encode sa parehong sum para sa susunod na generation
    ...
    cout << "========================================\n";
    cout << "  MULTI-LOG COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ Multi-log space evolution\n";
    cout << "  ✅ Match: " << matches << "/" << N << "\n";
    cout << "  ✅ Level 0\n\n";
