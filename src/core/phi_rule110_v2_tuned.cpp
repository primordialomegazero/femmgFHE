// ============================================
// φ-RULE 110 V2 TUNED — PINONG OPTIMIZATION
//
// Base: Multi-Log V2 (12/16)
// Tune: φ-powers para sa L, C, R
//
...
int main() {
    ...
    // I-tune ang φ-powers sa paligid ng V2 (φ⁻², φ⁰, φ¹)
    vector<double> L_powers = {-2.5, -2.25, -2.0, -1.75, -1.5};
    vector<double> R_powers = {0.75, 1.0, 1.25, 1.5};

    cout << "  L_power | R_power | Match\n";
    cout << "  --------|---------|------\n";

    int best_match = 0;
    double best_L = -2.0, best_R = 1.0;
