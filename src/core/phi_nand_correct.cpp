// ============================================
// φ-NAND CORRECT — TAMANG THRESHOLD
//
// NAND(a,b) = 1 kung (a + b) < 2φ
// NAND(a,b) = 0 kung (a + b) ≥ 2φ
//
// 0+0 = 2φ⁻¹ = 1.236 < 2φ = 3.236 → NAND = 1 ✅
// 0+1 = √5 = 2.236 < 2φ → NAND = 1 ✅
// 1+0 = √5 = 2.236 < 2φ → NAND = 1 ✅
// 1+1 = 2φ = 3.236 ≥ 2φ → NAND = 0 ✅
//
...
public:
    ...
    double decode_nand(const vector<complex<double>>& vals) {
        ...
        // NAND: 1 kung avg < 2φ, 0 kung avg ≥ 2φ
    ...
    // NAND: addition lang + threshold sa decode
