// ============================================
// φ-ARBITRARY 10K BOUNDED
// Arbitrary values na may bounded cycle
// Net effect: 1 (hindi lumalaki)
// ============================================
...
int main() {
    ...
    auto ct_add = encrypt_arbitrary(2.0);
    auto ct_sub = encrypt_arbitrary(1.0);
    
    vector<double> v_mul(4, 0.0);
    v_mul[2] = log(1.5) / LN_PHI;
    ...
    cout << "========================================\n";
    cout << "  " << (error < 1.0 ? "✅ ARBITRARY CONFIRMED" : "❌ MAY ISSUE") << "\n";
    cout << "========================================\n\n";
