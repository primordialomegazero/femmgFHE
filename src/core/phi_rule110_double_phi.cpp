// ============================================
// φ-RULE 110 DOUBLE PHI — DALAWANG φ
//
// φ₁ para sa state: 0→0, 1→φ₁⁻¹
// φ₂ para sa transition weights
//
...
int main() {
    ...
    // Double φ
    const double PHI1 = 1.6180339887498948482;  // φ (state)
    const double PHI2 = 2.6180339887498948482;  // φ² (transition)
    const double PHI1_INV = 1.0 / PHI1;
    const double PHI2_INV = 1.0 / PHI2;

    // State values (φ₁-based)
    const double S_ZERO = 0.0;
    const double S_ONE = PHI1_INV;  // φ₁⁻¹ = 0.618

    // Transition weights (φ₂-based)
    const double W_L_ZERO = 0.0;
    const double W_L_ONE = pow(PHI2, -1.5);  // φ₂⁻¹·⁵
    const double W_C_ZERO = 0.0;
    const double W_C_ONE = pow(PHI2, -1);    // φ₂⁻¹
    const double W_R_ZERO = PHI2 / 2.0;      // φ₂/2
    const double W_R_ONE = PHI2;             // φ₂

    cout << "  ✅ CKKS initialized (depth 0!)\n";
    cout << "  State: 0→0, 1→φ₁⁻¹=" << S_ONE << "\n";
    cout << "  Transition: φ₂=" << PHI2 << "\n\n";
    ...
    // ============================================
    // TRANSITION TABLE (DOUBLE φ)
    // ============================================

    cout << "========================================\n";
    cout << "  TRANSITION TABLE (DOUBLE φ)\n";
    cout << "========================================\n\n";
    ...
    cout << "========================================\n";
    cout << "  DOUBLE PHI COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ Double φ: φ₁=" << PHI1 << ", φ₂=" << PHI2 << "\n";
