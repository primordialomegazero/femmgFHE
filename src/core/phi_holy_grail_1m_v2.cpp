// ============================================
// φ-HOLY GRAIL 1M V2 — ALL ARITHMETIC
// Simple: puro EvalAdd/EvalSub lang
// Walang decrypt sa gitna, walang reconstruction
//
...
int main() {
    ...
    // Slot 2: frac
    // Slot 3: log_φ(x)
    // Slot 4-7: pre-computed reconstruction values
    // ============================================
    ...
    auto ct_state = encrypt_val(1.0);
    auto ct_two = encrypt_val(2.0);
    auto ct_three = encrypt_val(3.0);
    auto ct_one = encrypt_val(1.0);
    ...
    cout << "========================================\n";
    cout << "  HOLY GRAIL 1M V2 COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ 1M all arithmetic\n";
