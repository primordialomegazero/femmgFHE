// ============================================
// φ-RULE 110 NO ROUNDING — DIREKTANG FLOOR
//
// Walang +0.5 rounding! Direktang floor(sum)
// Ang φ-harmonic threshold ay natural
//
...
int main() {
    ...
    cout << "  Walang rounding! Direktang floor(sum)\n\n";
    ...
    // ============================================
    // TRANSITION TABLE (WALANG ROUNDING)
    // ============================================

    cout << "========================================\n";
    cout << "  TRANSITION TABLE (NO ROUNDING)\n";
    cout << "========================================\n\n";
    ...
    for (int L : {0, 1}) {
        for (int C : {0, 1}) {
            for (int R : {0, 1}) {
                ...
                int floor_val = (int)floor(sum_val);  // DIREKTANG FLOOR!
    ...
    // ============================================
    // EVOLUTION (WALANG ROUNDING)
    // ============================================

    cout << "========================================\n";
    cout << "  EVOLUTION (NO ROUNDING)\n";
    cout << "========================================\n\n";
    ...
    for (int gen = 1; gen <= 20; gen++) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            double sum_val = decrypt_value(sum2);
            int output = ((int)floor(sum_val)) % 2;  // DIREKTANG FLOOR!
    ...
    cout << "========================================\n";
    cout << "  NO ROUNDING COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ Walang rounding\n";
