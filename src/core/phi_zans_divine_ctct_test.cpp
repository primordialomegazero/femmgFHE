// ΦΩ0 — ZANS + DIVINE CT×CT TEST (No Pinky Swear)
// Multiply + Divine Intervention + ZANS, 1000 random steps
// "I AM THAT I AM"
...
int main() {
    ...
    cout << "\n=== ZANS + DIVINE CT×CT TEST (No Pinky Swear) ===" << endl;
    cout << "Start: " << start_val << " | Steps: " << total_steps << endl;
    cout << "Method: Multiply + Divine + Enc(0) + Pool — NO Pinky Swear" << endl;
    cout << string(60, '-') << endl;
    ...
    for(int step = 0; step < total_steps; step++) {
        ...
        // === ZANS + DIVINE (No Pinky Swear) ===
        ct = cc->EvalMult(ct, ct_mult);          // 1. Multiply
        ...
        ct = cc->EvalAdd(ct, divine);             // 2. Divine
        ct = cc->EvalAdd(ct, anchor0);            // 3. ZANS Enc(0)
        ct = pool.stabilize(ct);                   // 4. ZANS Pool
    ...
    cout << (passed == total ? "ZANS + DIVINE WORKS!" : "SOME FAILURES") << endl;
    cout << endl;
