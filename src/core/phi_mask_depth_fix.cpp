// ============================================
// φ-MASK DEPTH FIX — 10K
// Mas malalim na depth para ma-handle ang masking
// Walang plaintext access, walang decrypt sa gitna
//
...
int main() {
    ...
    cout << "  ✅ CKKS initialized (depth 10, 4 slots)\n\n";

    // ============================================
    // ENCODING — simple lang
    ...
    cout << "  Match (Slot 0): " << (abs(final_vals[0] - expected_add) < 10.0 ? "✅" : "❌") << "\n";
    cout << "  Match (Slot 1): " << (abs(final_vals[1] - expected_index) < 10.0 ? "✅" : "❌") << "\n\n";
