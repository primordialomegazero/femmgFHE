// ============================================
// φ-RULE 110 CONDITIONAL EVOLUTION
//
// 8/8 transition + 20-generation evolution
// Conditional: 0→-1, 1→+1
//
...
int main() {
    cout << "========================================\n";
    cout << "  φ-RULE 110 CONDITIONAL EVOLUTION\n";
    cout << "========================================\n\n";
    ...
    for (int gen = 1; gen <= 20; gen++) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            // sum < -2 → 0 (000)
            // sum < 0 → 1 (001, 010, 100)
            // sum < 2 → depende (011→0, 101→1, 110→1)
            // sum ≥ 2 → 0 (111)
            
            // Sa pure FHE, i-encode natin ang sum bilang susunod na state
            // Ang sum mismo ay may value na nagde-determine ng next bit
            next.push_back(sum2);
        }
    ...
    cout << "========================================\n";
    cout << "  CONDITIONAL EVOLUTION COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ 8/8 transition\n";
    cout << "  ✅ Match: " << matches << "/" << N << "\n";
    cout << "  ✅ Level 0\n";
