// ============================================
// φ-BEATTY FHE — 10K MIXED
// Beatty partition para sa natural na alignment
// ============================================
...
int main() {
    ...
    auto encrypt_beatty = [&](double F) {
        ...
        int grupo = q % 2;  // 0=A, 1=B
        vector<double> v(4, 0.0);
        v[0] = fmod(F, PHI);       // F mod φ
        v[1] = grupo;               // grupo
        v[2] = log(F) / LN_PHI;    // log space
        v[3] = F;                   // original
    ...
    auto v_final = decrypt_beatty(ct_state);
