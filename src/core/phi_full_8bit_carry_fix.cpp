// ============================================
// φ-FULL 8-BIT ALU WITH CARRY — FIXED
//
// Symmetric XOR3: 0→+φ/2, 1→+φ
// Sum: XOR3 decode (8/8 na)
// Carry: INVERTED decode
//
...
int main() {
    cout << "========================================\n";
    cout << "  φ-FULL 8-BIT ALU WITH CARRY — FIXED\n";
    cout << "========================================\n\n";
    ...
    cout << "  Full 8-bit ALU with carry (INVERTED carry)\n\n";
    ...
    // CARRY DECODE — INVERTED
    auto carry_decode = [&](double val) {
        double mod_2phi = fmod(val, TWO_PHI);
        
        // INVERTED:
        // 2 o 3 ones (2φ o 3φ) → 0
        // 0 o 1 one (0 o φ/2 o φ) → 1
    ...
    cout << "========================================\n";
    cout << "  FULL 8-BIT ALU COMPLETE — FIXED\n";
    cout << "========================================\n\n";
