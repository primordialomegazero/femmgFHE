// ============================================
// φ-FULL ADDER FINAL — 8/8 PERFECT
//
// Gates: 16/16 (dual space)
// Full Adder: 8/8 (space-aware Cout)
//
...
int main() {
    ...
    auto gate_or = [&](const Ciphertext<DCRTPoly>& a, const Ciphertext<DCRTPoly>& b) {
        return cc->EvalAdd(a, b);  // NORMAL SPACE OR
    };
    ...
    auto decode_or_normal = [&](const Ciphertext<DCRTPoly>& ct) {
        auto [_, normal_val] = decrypt_raw(ct);
    ...
    cout << "  A B | NAND(L) | AND(N) | OR(N) | XOR(N)\n";
    cout << "  ----|---------|--------|-------|--------\n";
    ...
    for (int A : {0, 1}) {
        for (int B : {0, 1}) {
            ...
            int or_r = decode_or_normal(gate_or(ct_a, ct_b));
    ...
    cout << "========================================\n";
    cout << "  FULL ADDER FINAL COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ Depth 0\n";
