// ============================================
// φ-PERFECT V7 — SPECIAL CASE HANDLING
//
// ANG SPECIAL CASE: 0+0+0 = 3φ⁻¹ = 1.854
// Ito ay dapat 0, pero nasa "1 zone"
//
// ANG FIX: φ-AWARE ROUNDING
// Kung avg ≈ 3φ⁻¹ → 0
//
...
public:
    PhiPerfectV7() {
        ...
        cout << "========================================\n";
        cout << "  φ-PERFECT V7 — SPECIAL CASE\n";
        cout << "========================================\n\n";
    }
    ...
    double decode(const vector<complex<double>>& vals) {
        ...
        // EMERGENT φ-RECOGNITION:
        // I-check muna kung malapit sa φ-harmonic values
        double three_phi_inv = 3.0 * PHI_INV;  // 1.854
        double two_phi_inv = 2.0 * PHI_INV;    // 1.236
        double sqrt5 = PHI + PHI_INV;          // 2.236
        double two_phi = 2.0 * PHI;            // 3.236
