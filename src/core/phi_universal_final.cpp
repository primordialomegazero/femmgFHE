// ============================================
// φ-UNIVERSAL FINAL — 16/16 + 8/8
//
// Space-aware:
// NAND → Log (0→-2, 1→+2)
// AND → Normal (0→0, 1→1)  
// OR → Normal (0→0, 1→1) — para sa adder
// XOR → Normal (0→0, 1→1)
//
// Full Adder: LAHAT sa normal space
//
...
int main() {
    cout << "========================================\n";
    cout << "  φ-UNIVERSAL FINAL — 16/16 + 8/8\n";
    cout << "========================================\n\n";
    ...
    auto encrypt_dual = [&](int bit) {
        ...
        v[0] = (bit == 0) ? -2.0 : 2.0;  // Log space (NAND)
        v[4] = (bit == 0) ? 0.0 : 1.0;   // Normal space (AND/OR/XOR)
    ...
    // ============================================
    // TEST 2: FULL ADDER (8/8) — ALL NORMAL SPACE
    // ============================================
