// ============================================
// φ-RULE 110 GRAMMAR — TAMANG WIKA
//
// Encoding: 0 → φ, 1 → φ⁻¹
// Transition: φ-grammar rules
// Period-3 rhythm
//
...
int main() {
    ...
    cout << "  φ-grammar: 0→φ, 1→φ⁻¹\n\n";

    int rule110[8] = {0, 1, 1, 0, 1, 1, 1, 0};

    auto encrypt_grammar = [&](int bit) {
    ...
    cout << "========================================\n";
    cout << "  EVOLUTION (φ-GRAMMAR)\n";
    cout << "========================================\n\n";

    vector<Ciphertext<DCRTPoly>> cells;
    for (int bit : history[0]) {
        cells.push_back(encrypt_grammar(bit));
    }
    ...
    for (int gen = 1; gen <= 20; gen++) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            // φ-grammar transition: sum ng φ-values
        ...
        if (gen % 5 == 0 || gen == 20) {
            cout << "  Gen " << setw(3) << gen << ": ";
            for (int i = 0; i < N; i++) {
                double val = decrypt_grammar(current[i]);
                // Decode: φ > threshold → 0, φ⁻¹ < threshold → 1
                int bit = (val < 3.0) ? 1 : 0;
                cout << bit;
            }
            cout << "\n";
    ...
    cout << "========================================\n";
    cout << "  φ-GRAMMAR COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ φ-grammar evolution\n";
    cout << "  ✅ Match: " << matches << "/" << N << "\n";
    cout << "  ✅ Level 0\n\n";
