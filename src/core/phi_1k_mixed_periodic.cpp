// ============================================
// φ-1K MIXED PERIODIC
// Full mixed operations na may periodic sync
// Sync bawat 10 ops — hindi per-operasyon
// ============================================
...
int main() {
    ...
    for (int i = 0; i < N; i++) {
        ...
        if (ops_since_sync >= sync_interval) {
            // Sync: decrypt para makuha ang normal space, re-encode
