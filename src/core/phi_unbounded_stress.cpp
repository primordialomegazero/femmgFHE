// ============================================
// φ-UNBOUNDED STRESS — 100K Ops Walang Mod
// Exponent unbounded, walang error accumulation
// Natural na φ-periodicity sa recovery
// ============================================
...
int main() {
    ...
    cout << "========================================\n";
    cout << "  φ-UNBOUNDED STRESS — 100K Ops Walang Mod\n";
    cout << "========================================\n\n";
    ...
    for (int i = 0; i < N; i++) {
        ...
        if (i % 25000 == 0 && i > 0) {
            ...
            cout << "    Step " << setw(5) << i << ": n=" << setw(12) << n_now
                 << ", expected=" << setw(12) << expected_n
                 << ", diff=" << setw(10) << (n_now - expected_n) << "\n";
        }
    }
    ...
    cout << "  Final value (φ-mod): " << pow(PHI, fmod(n_final, PHI)) << "\n";
