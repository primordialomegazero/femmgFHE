// ============================================
// φ-RULE 110 ASYMMETRIC R — FINAL TWEAK
//
// L: φ⁻¹, C: φ⁰, R: φ¹ (left side)
// R: φ⁰·⁵ (right side adjustment)
//
...
int main() {
    ...
    // ============================================
    // ASYMMETRIC R EVOLUTION
    // ============================================

    cout << "========================================\n";
    cout << "  EVOLUTION (ASYMMETRIC R)\n";
    cout << "========================================\n\n";
    ...
    for (int bit : history[0]) {
        ...
        cells_R.push_back(encrypt_multi(bit, PHI));
    }
    ...
    cout << "========================================\n";
    cout << "  ASYMMETRIC R COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ Asymmetric R evolution\n";
    cout << "  ✅ Match: " << matches << "/" << N << "\n";
    cout << "  ✅ Level 0\n\n";
