// ============================================
// φ-PRODUCTION V6 — BIT-ONLY SECURITY FIX
//
// STRUCTURE (from working source):
// - MultiplicativeDepth(1) — LEVEL 0 FOREVER
// - ScalingModSize(20) — stable
// - BatchSize(16) — 16 slots
// - HEStd_128_classic — 128-bit security
//
// BIT-ONLY ADJUSTMENT:
// - HEStd_256_classic — 256-bit quantum-safe
// - NO SetRingDim — default (32768)
// - NO SetFirstModSize — auto-computed
//
...
public:
    PhiProductionV6() : operation_count(0), accumulated_noise(0.0) {
        // WORKING STRUCTURE — MultiplicativeDepth(1) for LEVEL 0
    ...
    void runTests() {
        ...
        cout << "========================================\n";
        cout << "  φ-PRODUCTION V6 — BIT-ONLY FIX\n";
        cout << "========================================\n\n";
