// ============================================
// φ-ARBITRARY 10K — REAL WORLD
// Arbitrary values: 7, 11, 23, 47, 100, 255
// Hindi Fibonacci, hindi φ-power
// ============================================
...
int main() {
    ...
    cout << "========================================\n";
    cout << "  φ-ARBITRARY 10K — REAL WORLD\n";
    cout << "========================================\n\n";

    int N = 10000;

    cout << "  Operations: " << N << "\n";
    cout << "  Values: 7, 11, 23, 47, 100, 255\n";
    cout << "  Cycle: +7, -3, ×2, ÷1.5\n";
    ...
    cout << "  Final Slot 0 (F):      " << scientific << setprecision(6) << v_final[0] << "\n";
    ...
    cout << "========================================\n";
    cout << "  " << (error < 1.0 ? "✅ ARBITRARY VALUES CONFIRMED" : "❌ MAY ISSUE") << "\n";
    cout << "========================================\n\n";
