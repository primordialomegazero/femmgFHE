// ============================================
// φ-RULE 110 ZERO FIX FINAL — NEGATIVE ZERO FIX
//
// Ang -0.000 ay may floor -1. Kailangan ng zero fix.
// Kung |val| < ε, gawing 0.
//
...
int main() {
    cout << "========================================\n";
    cout << "  φ-RULE 110 ZERO FIX FINAL\n";
    cout << "========================================\n\n";
    ...
    const double EPSILON = 0.001;  // Zero threshold
    ...
    auto decrypt_value = [&](const Ciphertext<DCRTPoly>& ct) {
        ...
        double avg = sum / 16.0;
        // ZERO FIX: kung malapit sa 0, gawing eksaktong 0
        if (abs(avg) < EPSILON) return 0.0;
        return avg;
    };
    ...
    // ============================================
    // EVOLUTION NA MAY ZERO FIX
    // ============================================

    cout << "========================================\n";
    cout << "  EVOLUTION (ZERO FIX)\n";
    cout << "========================================\n\n";
    ...
    for (int gen = 1; gen <= 20; gen++) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            double sum_val = decrypt_value(sum2);  // May zero fix na
            int output = ((int)floor(sum_val)) % 2;
            if (output < 0) output = 0;  // Negative fix
    ...
    cout << "========================================\n";
    cout << "  ZERO FIX FINAL COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ Zero fix: |val| < " << EPSILON << " → 0\n";
    cout << "  ✅ Negative fix: output < 0 → 0\n";
    cout << "  ✅ Match: " << matches << "/" << N << "\n";
    cout << "  ✅ Level 0\n";
    cout << "  ✅ Depth 0\n";
