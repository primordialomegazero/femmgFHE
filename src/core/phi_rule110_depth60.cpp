// ============================================
// φ-RULE 110 DEPTH 60 — EVOLUTION BUDGET
//
// Depth 60 = sapat para sa 20 generations
// 20 gens × 2 EvalAdd = 40 ops
// Depth 60 may sapat na buffer
//
...
int main() {
    ...
    cout << "  ✅ CKKS initialized (depth 60, modsize 59)\n";
    cout << "  Budget: 20 generations × 2 EvalAdd\n\n";
    ...
    cout << "========================================\n";
    cout << "  TRANSITION TABLE (DEPTH 60)\n";
    cout << "========================================\n\n";
