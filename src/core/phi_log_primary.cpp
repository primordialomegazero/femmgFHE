// ============================================
// φ-LOG PRIMARY — 10K
// Slot 2 (log) bilang primary na may φ-period
// ============================================
...
int main() {
    ...
    cout << "========================================\n";
    cout << "  φ-LOG PRIMARY — 10K\n";
    cout << "========================================\n\n";

    int N = 10000;

    cout << "  Operations: " << N << "\n";
    cout << "  Log space bilang primary\n";
    cout << "  φ-period sa log space\n";
    cout << "  Running...\n\n";

    auto ct_state = encrypt_log(3.0);
    
    // Deltas sa log space
    auto ct_up = encrypt_log(0.5);
    auto ct_down = encrypt_log(-0.3);

    auto start = high_resolution_clock::now();

    for (int i = 0; i < N; i++) {
        if (i % 2 == 0) {
            ct_state = cc->EvalAdd(ct_state, ct_up);
        } else {
            ct_state = cc->EvalAdd(ct_state, ct_down);
        }
    }
