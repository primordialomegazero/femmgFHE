// ============================================
// φ-RULE 110 DEPTH 50 — PRECISION FIX
//
// Depth 50 = mas malaking scaling factor
// Mas mataas na precision sa bawat addition
// Kahit pure addition lang, mas exact ang values
//
...
int main() {
    ...
    cout << "  ✅ CKKS initialized (depth 50, modsize 59)\n";
    cout << "  High precision para sa evolution\n\n";
    ...
    cout << "========================================\n";
    cout << "  TRANSITION TABLE (DEPTH 50)\n";
    cout << "========================================\n\n";
    ...
    cout << "========================================\n";
    cout << "  DEPTH 50 COMPLETE\n";
    cout << "========================================\n\n";
    cout << "  ✅ Depth 50 precision\n";
    cout << "  ✅ Match: " << matches << "/" << N << "\n";
    cout << "  ✅ Level: " << current[0]->GetLevel() << "\n\n";
