// ============================================
// φ-PERFECT V6 — FLOOR + TOLERANCE
//
// ANG FIX:
// floor(avg/φ + 0.0000001) mod 2
//
// Kasi ang floating point ay nagbibigay ng:
// 2.000000000 → 1.999999999 → floor = 1 (dapat 2)
//
// TOLERANCE: 0.0000001 ang fix!
//
...
public:
    PhiPerfectV6() {
        ...
        cout << "========================================\n";
        cout << "  φ-PERFECT V6 — FLOOR + TOLERANCE\n";
        cout << "========================================\n\n";
    }
    ...
    double decode(const vector<complex<double>>& vals) {
        ...
        double floored = floor(quotient + 0.0000001);  // TOLERANCE FIX
