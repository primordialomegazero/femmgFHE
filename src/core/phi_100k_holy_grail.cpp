// ============================================
// φ-100K HOLY GRAIL
// 100,000 operations — pure FHE chain
// 10K checkpoints
// ============================================
...
int main() {
    ...
    cout << "========================================\n";
    cout << "  φ-100K HOLY GRAIL STRESS TEST\n";
    cout << "========================================\n\n";
    ...
    cout << "  Operations: " << N << "\n";
    cout << "  Checkpoint: bawat " << checkpoint << " ops\n";
    cout << "  Mix: +F_3, +F_5, ×F_4, ÷F_2\n";
    ...
    for (int i = 0; i < N; i++) {
        ...
        if ((i + 1) % checkpoint == 0) {
            ...
            cout << "  [" << (i + 1) << " ops] result=" << fixed << setprecision(2) << result 
                 << " expected=" << expected << " ";
            if (match) { cout << "✅\n"; pass++; } else { cout << "❌\n"; fail++; }
