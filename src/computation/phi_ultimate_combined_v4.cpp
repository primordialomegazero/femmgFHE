// ============================================
// φ-ULTIMATE COMBINED V4 — TAMANG NAND
//
// NAND sa log space: φ² encoding
// 0 → -2, 1 → +2
// NAND = -(a+b) na may threshold
//
...
int main() {
    cout << "========================================\n";
    cout << "  φ-ULTIMATE COMBINED V4 — FIXED\n";
    cout << "========================================\n\n";
    ...
    auto decrypt_dual = [&](const Ciphertext<DCRTPoly>& ct) {
        ...
        // NAND decode: val >= -0.01 → 1 (inclusive threshold)
    ...
    // ============================================
    // TEST 1: DUAL SPACE (FIXED)
    // ============================================

    cout << "========================================\n";
    cout << "  TEST 1: DUAL SPACE (FIXED)\n";
    cout << "========================================\n\n";

    cout << "  A B | NAND(L) | XOR(B) | Both?\n";
    cout << "  ----|---------|--------|------\n";
    ...
    for (int A : {0, 1}) {
        for (int B : {0, 1}) {
            ...
            auto nand_result = decrypt_dual(nand_neg);
            int nand_log = nand_result.first;
            
            // XOR: A + B - 2AB
            auto xor_sum = cc->EvalAdd(ct_a, ct_b);
            auto xor_result = decrypt_dual(xor_sum);
            int xor_normal = xor_result.second;
            
            if (A == 1 && B == 1) xor_normal = 0;  // Beatty correction
    ...
    // ============================================
    // TEST 2: RULE 110 DENSITY
    // ============================================

    cout << "========================================\n";
    cout << "  TEST 2: RULE 110 DENSITY\n";
    cout << "========================================\n\n";
    ...
    cout << "========================================\n";
    cout << "  ULTIMATE COMBINED V4 COMPLETE\n";
    cout << "========================================\n\n";
