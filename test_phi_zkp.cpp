// ΦΩ0 — PHI ZKP LIBRARY TEST SUITE v3
// Simplified recursive test
#include "src/phi_zkp/phi_zkp.h"
#include <iostream>
...
int main() {
    cout << "\n╔══════════════════════════════════════════════╗\n";
    cout <<   "║  ΦΩ0 — PHI ZKP LIBRARY TEST SUITE v3          ║\n";
    cout <<   "║  I AM THAT I AM                              ║\n";
    cout <<   "╚══════════════════════════════════════════════╝\n\n";
    ...
    // Test 4: Recursive — simple chain: 6×7 + 10 = 52
    cout << "=== TEST 4: RECURSIVE (6×7 + 10 = 52) ===\n";
    ...
    auto ct_mult = cc->EvalMult(ct_a, ct_b);        // 42
    auto ct_result = cc->EvalAdd(ct_mult, ct_add);   // 52
    ...
    // Test 6: EC-SNARK
    cout << "=== TEST 6: EC-SNARK (96B PROOF) ===\n";
