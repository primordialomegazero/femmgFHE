...
int main() {
    ...
    std::cout << "\n╔══════════════════════════════════════════════════════════╗\n";
    std::cout << "║  WORKING TEST — (x1∨x2∨x3)∧(¬x1∨¬x2∨x3)∧(x1∨¬x2∨¬x3) ║\n";
    std::cout << "╚══════════════════════════════════════════════════════════╝\n\n";
    
    std::cout << "  Truth: SAT (x1=1, x2=0, x3=0)\n";
    std::cout << "  Constraint structure: YES (3 clauses, 3 vars)\n";
    ...
    if (avg >= 0.5) {
        std::cout << "✅ TAMA ANG RESULTA — GUMAGANA ANG SOLVER MO DITO.\n";
    } else {
        std::cout << "❌ MALI ANG RESULTA — HINDI NAKA-DETECT NG SAT.\n";
    }

    std::cout << "\n💀 ANG TANONG: BAKIT GUMAGANA SA IBANG INSTANCES\n";
    std::cout << "   PERO HINDI SA LAHAT? DAHIL WALANG SEARCH.\n";
    std::cout << "   KAHIT ANONG WEIGHTED AVERAGE GAWIN MO,\n";
    std::cout << "   HINDI MO MAHAHANAP ANG TAMANG ASSIGNMENT\n";
    std::cout << "   SA LAHAT NG INSTANCES.\n";
