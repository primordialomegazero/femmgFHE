#include "../src/chaos/heisenberg_uncertainty.h"
#include <iostream>

using namespace heisenberg_uncertainty;

int main() {
    std::cout << "═══════════════════════════════════════" << std::endl;
    std::cout << "  HEISENBERG UNCERTAINTY ENGINE TEST" << std::endl;
    std::cout << "  \"Observing changes the observed.\"" << std::endl;
    std::cout << "═══════════════════════════════════════" << std::endl;
