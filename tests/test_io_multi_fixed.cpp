// iO MULTI-CIRCUIT TEST — FIXED LAHAT
#include "openfhe.h"
#include <iostream>
#include <vector>
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  iO MULTI-CIRCUIT — FIXED\n";
    std::cout << "========================================\n\n";
    ...
    // AND2: NAND(NOT(a), NOT(b)) — de Morgan
    auto AND2 = [&](Ciphertext<DCRTPoly> a, Ciphertext<DCRTPoly> b) {
        return nand(NOT(a), NOT(b));
    };

    // AND3: NOT(OR(NOT(a), NOT(b))) — de Morgan alternative
    ...
    // OR3: NAND(NAND(a,a), NAND(b,b)) — simpleng NAND
