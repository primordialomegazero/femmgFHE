// 8-BIT SPIRAL: Auto-correction on 72 gates
#include <iostream>
#include <iomanip>
#include <cmath>
#include <cstdlib>
...
int main(){
    std::cout<<"\n  8-BIT SPIRAL ADDER: 72 gates, auto-correction\n\n";
    
    CCParams<CryptoContextCKKSRNS> p;
    p.SetMultiplicativeDepth(300);p.SetScalingModSize(50);p.SetBatchSize(2048);
    ...
    int bits=8; int a_bits[bits],b_bits[bits];
    ...
    for(int i=bits-1;i>=0;i--){
        ...
        PE X1=spiral_correct(cc,nand_direct(cc,a,b),3);
        PE X2=spiral_correct(cc,nand_direct(cc,a,X1),3);
        PE X3=spiral_correct(cc,nand_direct(cc,b,X1),3);
        PE X4=spiral_correct(cc,nand_direct(cc,X2,X3),3);
        PE X5=spiral_correct(cc,nand_direct(cc,X4,rCarry),3);
        PE X6=spiral_correct(cc,nand_direct(cc,X4,X5),3);
        PE X7=spiral_correct(cc,nand_direct(cc,X5,rCarry),3);
        PE SUM=spiral_correct(cc,nand_direct(cc,X6,X7),3);
        PE COUT=spiral_correct(cc,nand_direct(cc,X1,X5),3);
    ...
    std::cout<<"  8-BIT SPIRAL: "<<(result==expected?"MATCH! 72 gates!":"needs work")<<"\n\n";
    return 0;
}
