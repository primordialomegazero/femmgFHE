// FLEXIBLEAUTOEXT — φ-LIKE MODULUS SPACING
// Subukan kung ang FLEXIBLEAUTOEXT ay makakapag-extend
// ng practical depth nang walang bootstrapping
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  FLEXIBLEAUTOEXT — 80 GATES\n";
    std::cout << "  Depth 80, Scaling 30, Batch 256\n";
    std::cout << "========================================\n\n";
    ...
    std::cout << "  Multiplications: " << total_gates << "\n";
