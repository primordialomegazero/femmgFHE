// BINFHE 32-BIT ADDER — Full Scale Test
// 32 full adders na naka-chain
// 32 random samples
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  BINFHE 32-BIT ADDER\n";
    std::cout << "  32 Random Samples\n";
    std::cout << "========================================\n\n";
    ...
    std::cout << "TESTING 32 RANDOM SAMPLES (32-bit)...\n";
    std::cout << "========================================\n\n";

    auto t_start = high_resolution_clock::now();

    for (int test = 0; test < total_tests; test++) {
        uint32_t a_val = rng() % 4294967296ULL;
        uint32_t b_val = rng() % 4294967296ULL;
        ...
        int expected_carry = ((uint64_t)a_val + b_val) > 4294967295ULL ? 1 : 0;
