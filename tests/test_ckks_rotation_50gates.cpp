// CKKS ROTATION BOOTSTRAP — 50 GATES SCALE UP
// Refresh every 10 gates
// TARGET: 50 gates, 0 errors
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  CKKS ROTATION BOOTSTRAP — 50 GATES\n";
    std::cout << "========================================\n\n";

    // Mas malalim na depth para sa 50 gates + refreshes
    ...
    std::cout << "50 GATES (refresh every 10):\n";
    std::cout << "=============================\n\n";

    auto current = make_ct(1.0);
    int errors = 0;
    int total_gates = 50;
    int refresh_every = 10;
    int refresh_count = 0;
