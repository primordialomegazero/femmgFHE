// RLWE L(k) FHE — FULL MATRIX TEST
// N=128/1024, Q=257/2048-bit, depth=100, security audit
...
int main() {
    std::cout << "RLWE L(k) FHE — FULL MATRIX\n";
    std::cout << "===========================\n\n";
    
    // 2048-bit Q
    NTL::ZZ Q2048 = NTL::to_ZZ("");
    
    NTL::ZZ Q257 = NTL::to_ZZ("115792089237316195423570985008687907853269984665640564039457584007913129640731");
    
    std::vector<Config> configs = {
        {128, Q257, "N=128, Q=257-bit"},
        {1024, Q257, "N=1024, Q=257-bit"},
        {128, Q2048, "N=128, Q=2048-bit"}
    };
    ...
    for (auto& cfg : configs) {
        ...
        std::cout << "  Time: " << ms << " ms\n";
        std::cout << "  Ops/sec: " << (51.0 * 1000.0 / ms) << "\n\n";
    }
