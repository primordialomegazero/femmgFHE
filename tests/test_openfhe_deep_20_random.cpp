// TEST: 20 depths with 1000 random inputs
...
int main() {
    std::cout << "1000 RANDOM INPUTS × 20 DEPTHS\n";
    std::cout << "===============================\n\n";
    ...
    std::cout << "Testing " << total_tests << " random inputs...\n\n";
    ...
    for (int test = 0; test < total_tests; test++) {
        ...
        // Apply 20 depths (proven working)
    ...
    if (failed == 0) {
        std::cout << "\n✅ 1000 RANDOM INPUTS × 20 DEPTHS = PERFECT!\n";
        std::cout << "✅ PERIOD-2 WORKS FOR ALL INPUTS!\n";
    }
