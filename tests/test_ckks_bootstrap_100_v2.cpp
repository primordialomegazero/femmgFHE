// CKKS BOOTSTRAPPING — 100 GATES (Slots 1024)
// May available precomputations ang 1024 slots
...
int main() {
    ...
    // Depth 10, bootstrap tuwing 5 gates
    ...
    cc->EvalBootstrapKeyGen(keys.secretKey, 1024);
