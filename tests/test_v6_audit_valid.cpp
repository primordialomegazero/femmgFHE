...
int main() {
    ...
    bool fresh = (ct0.first != ct1.first);
    ...
    bool blind_diff = (fhe.decrypt(fhe.blind(ct1)) == fhe.decrypt(ct1));
    ...
    std::cout << "OR(0,0): " << (or_ok ? "PASS ✓" : "FAIL ✗") << "\n";
    std::cout << "CNOT(1,0): " << (cnot_ok ? "PASS ✓" : "FAIL ✗") << "\n";
    std::cout << "Blinding: " << (blind_diff ? "PASS ✓" : "FAIL ✗") << "\n";
