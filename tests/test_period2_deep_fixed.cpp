// DEEP: Period-2 with 65536 ring dimension
#include "openfhe.h"
#include <iostream>
...
int main() {
    std::cout << "DEEP PERIOD-2 NAND (65536 ring)\n";
    std::cout << "=================================\n\n";

    CCParams<CryptoContextBFVRNS> parameters;
    parameters.SetPlaintextModulus(65537);
    parameters.SetMultiplicativeDepth(30);
    parameters.SetRingDim(65536);  // FIXED: 65536
    ...
    std::cout << "Generating keys... (this may take a few minutes)\n";
    auto keys = cc->KeyGen();
    ...
    if (errors == 0) {
        std::cout << "\n✅ PERIOD-2 CONFIRMED AT 30 DEPTHS WITH 65536 RING!\n";
        std::cout << "✅ NOISE BUDGET IS SUFFICIENT!\n";
    }
