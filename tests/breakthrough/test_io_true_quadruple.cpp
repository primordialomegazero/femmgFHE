...
// Gate 2: AND via De Morgan: !(!X OR !Y)
...
// Gate 3: AND via Arithmetic inverse transform
...
int main(int argc, char* argv[]) {
    ...
    GateFunc gates[4] = {gate_standard, gate_nand_not, gate_demorgan, gate_arithmetic};
    
    time_t st = time(0);
    std::cout << "\n";
    std::cout << "  True Quadruple iO\n";
    std::cout << "  4 structurally different, functionally equivalent gates\n";
    ...
    std::cout << "    Standard:  " << gate_usage[0] << "\n";
    std::cout << "    NAND+NOT:  " << gate_usage[1] << "\n";
    std::cout << "    De Morgan: " << gate_usage[2] << "\n";
    std::cout << "    Arithmetic:" << gate_usage[3] << "\n\n";
