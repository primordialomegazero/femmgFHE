/*
 * UK×UK WITH TENSOR DECOMPOSITION - ULTIMATE
 * Deretso implementation: tensor + scaling correction + ZANS
 */
...
Ciphertext tensor_multiply(
    ...
    // For now, we use plaintext decomposition
    // In production, need homomorphic decomposition
    
    // I-encrypt ang factors (for demo only)
...
int main() {
    ...
    // ========================================
    // APPROACH 4: Tensor with Multiple Decompositions
    // ========================================
    cout << "\n--- APPROACH 4: Multiple Decompositions ---\n";
    
    // Subukan ang iba't ibang decomposition
