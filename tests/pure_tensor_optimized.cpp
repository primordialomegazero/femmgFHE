/*
 * PURE TENSOR DECOMPOSITION - OPTIMIZED
 * Walang Fibonacci, pure tensor lang
 * Hanapin ang best parameters
 */
...
Ciphertext pure_tensor_multiply(
    ...
    int mod,
    int split_ratio = 2  // a1 = a/split_ratio
) {
...
int main() {
    cout << "\n";
    cout << "========================================\n";
    cout << "  PURE TENSOR DECOMPOSITION\n";
    cout << "========================================\n\n";
    ...
    cout << "  CONCLUSION\n";
    cout << "========================================\n";
    cout << "  Best split ratio: " << best_ratio << "\n";
