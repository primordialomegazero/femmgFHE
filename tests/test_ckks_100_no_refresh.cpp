// CKKS 100 GATES — NO REFRESH
// Pure NAND chain, walang scale switching
// Depth 140 para sa 100 gates
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  CKKS 100 GATES — NO REFRESH\n";
    std::cout << "  Pure NAND Chain\n";
    std::cout << "========================================\n\n";
    ...
    for (int gate = 0; gate < total_gates; gate++) {
        ...
        if (gate < 3 || gate >= total_gates - 3 || gate % 20 == 0) {
