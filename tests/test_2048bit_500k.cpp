// 2048-BIT POST-QUANTUM — 500K NAND STRESS TEST
// Every 50K print, walang timeout
...
int main() {
    std::cout << "2048-BIT POST-QUANTUM: 500K NAND STRESS TEST\n";
    std::cout << "=============================================\n\n";
    ...
    std::cout << "=== 500K NAND OPERATIONS (50K print) ===\n";
    std::cout << "Estimated time: ~10 hours (14.7 ops/sec)\n\n";
    ...
    if (total_time > 0) {
        std::cout << "Ops/sec: " << (500000.0 / total_time) << "\n";
    }
