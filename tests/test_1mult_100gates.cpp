// 1-MULT NAND — 100 GATES, DEPTH 100
// Standard NAND: 1 - a·b
// Ito ang pinakamataas na praktikal na depth para sa 16GB RAM
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  1-MULT NAND — 100 GATES\n";
    std::cout << "  Depth 100, Batch 256\n";
    std::cout << "========================================\n\n";
    ...
    std::cout << "100 GATES — 1 MULT EACH\n";
    std::cout << "========================\n\n";
