/*
 * STABLE CHAIN - 30-BIT MODULUS FINAL
 * Para sa larger values
 */
...
int main() {
    cout << "\n";
    cout << "========================================\n";
    cout << "  STABLE CHAIN - 30-BIT MODULUS\n";
    cout << "========================================\n\n";
    ...
    parms.set_plain_modulus(PlainModulus::Batching(16384, 30));  // 30 bits
    ...
    cout << "--- CHAIN: Multiply by 11 (30-bit modulus) ---\n";
    cout << "  Plaintext modulus: 2^30 = 1,073,741,824\n\n";
