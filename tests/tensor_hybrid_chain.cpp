/*
 * TENSOR HYBRID CHAIN
 * Tensor for single multiplication
 * Direct for chain
 */
...
// Direct multiplication with ZANS
Ciphertext direct_multiply_zans(
    Evaluator& evaluator,
...
int main() {
    ...
    for (int i = 1; i <= 20; i++) {
        ct_result = direct_multiply_zans(
