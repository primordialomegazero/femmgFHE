// RULE 110 PERIOD-0 — FIXED
// May mod 1 sa bawat step para hindi sumabog
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  RULE 110 PERIOD-0 — FIXED\n";
    std::cout << "  Mod 1 sa bawat step\n";
    std::cout << "========================================\n\n";
    ...
    init[128] = {0.5, 0.0};  // Magsimula sa 0.5 para sa mas magandang distribution
    auto state = cc->Encrypt(keys.publicKey, cc->MakeCKKSPackedPlaintext(init));

    std::cout << "RULE 110 PERIOD-0 FIXED (100 steps):\n";
    std::cout << "=====================================\n\n";
    ...
    for (int step = 0; step < 100; step++) {
        ...
        // Magdagdag ng φ² at mag-mod 1
        state = cc->EvalAdd(sum, ct_phi);
        
        // Mod 1 — subtract 1 hanggang < 1
    ...
    std::cout << "  Status: ✅ RULE 110 PERIOD-0 FIXED!\n";
    std::cout << "========================================\n";
