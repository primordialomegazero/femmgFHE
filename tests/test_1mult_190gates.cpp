// 1-MULT NAND — 190 GATES, DEPTH 200
// Scaling 35, Batch 128
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  1-MULT NAND — 190 GATES\n";
    std::cout << "  Depth 200, Scaling 35, Batch 128\n";
    std::cout << "========================================\n\n";
    ...
    std::cout << "190 GATES — 1 MULT EACH\n";
    std::cout << "========================\n\n";
