...
int main() {
    int max_steps = 75;
    cout << "\n  ╔══════════════════════════════════════════════════════╗\n";
    cout <<   "  ║   ΦΩ0 — TRUE CTxCT: " << max_steps << " mults, RING=8192               ║\n";
    cout <<   "  ╚══════════════════════════════════════════════════════╝\n";
    SelfHealingFHEv5 fhe(13, 20, 15);
    ...
    cout << "  Final error: " << err << " | Bootstraps: " << fhe.get_bootstrap_count()
         << " | Time: " << duration_cast<seconds>(t1-t0).count() << "s\n";
    bool pass = err < 0.01;
    cout << "  Result: " << (pass ? "PASSED" : "FAILED") << "\n\n";
    return pass ? 0 : 1;
}
