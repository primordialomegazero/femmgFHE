#include "src/np/golden_multi_strategy.h"
#include <iostream>
#include <random>
#include <chrono>

int main() {
    std::cout << "=== GOLDEN MULTI-STRATEGY SAT ===\n\n";
    ...
    for (int num_vars : {10, 50, 100, 200, 300, 500, 1000, 2000, 5000, 10000, 20000, 50000}) {
        ...
        auto result = GoldenMultiStrategy::GoldenMultiStrategySolver::solve(clauses, num_vars);
