...
int main() {
    std::cout << "=== GOLDEN CDCL SOLVER (with Learning) ===\n\n";
    ...
    // Test 1: Triangle
    {
        ...
        std::cout << "Triangle: " << (result.satisfiable ? "PASS" : "FAIL") << "\n";
    }
    
    // Test 2: 3-colorable graphs
    std::cout << "\n--- 3-Colorable Graphs ---\n";
    for (int num_vertices = 10; num_vertices <= 100; num_vertices += 10) {
