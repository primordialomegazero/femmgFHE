// 10,000 STEPS — FINAL CONFIRMATION
// Period-4 cycle na 0-level at perfect
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  10,000 STEPS — FINAL CONFIRMATION\n";
    ...
    for (int step = 0; step < total_steps; step++) {
        current = cycle_step(current, step);
    ...
    std::cout << "  Accuracy: " << (100.0 * (total_steps - errors) / total_steps) << "%\n";
    std::cout << "  Time: " << total_ms / 1000.0 << "s\n";
    std::cout << "  Per step: " << (double)total_ms / total_steps << " ms\n";
    std::cout << "  Level: " << current->GetLevel() << "\n";
    std::cout << "  Depth used: " << current->GetLevel() << "/5\n";
    std::cout << "  Status: " << (errors == 0 ? "🏆 PERFECT!" : "❌ DRIFT") << "\n";
    std::cout << "========================================\n";
