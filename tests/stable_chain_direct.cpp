/*
 * STABLE CHAIN - DIRECT MULTIPLICATION + ZANS-M
 * Walang tensor decomposition, direct UK×UK lang
 * ZANS-M (plaintext ×1) for stability
 */
...
int main() {
    cout << "\n";
    cout << "========================================\n";
    cout << "  STABLE CHAIN - DIRECT MULTIPLICATION\n";
    cout << "========================================\n\n";
