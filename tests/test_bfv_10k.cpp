// BFV 10K GATES — Ultimate Boundedness Test
...
int main() {
    ...
    std::cout << "CHAIN TEST (10,000 gates):\n";
    std::cout << "=========================\n\n";
    ...
    std::cout << "  Status: " << (std::abs(final_val) < 65537 ? "✅ BFV 10K BOUNDED!" : "⚠️ MAY ISSUE") << "\n";
