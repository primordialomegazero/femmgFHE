// BINFHE 8-BIT ADDER — 256 SAMPLES
// Hindi lahat ng 65,536 pairs — 256 lang na representative
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  BINFHE 8-BIT ADDER — 256 SAMPLES\n";
    std::cout << "========================================\n\n";
    ...
    std::cout << "TESTING 256 RANDOM SAMPLES...\n";
    std::cout << "==============================\n\n";
